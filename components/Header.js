      ...
      <div className="header">
        ...
        <div>
          ...
          <input id="searchField" placeholder="Search" type="text"
                 className="devsiteSearchField_input devsite-search-query" onChange={this.triggerSearch.bind(this)}/>
        </div>
        }
        {isCountryDetailsView &&
        <div>
          <h1 className="headerTitle color_FF text-center" onClick={this.redirectHome.bind(this)}>
             <span className="icon-back ion-arrow-left-c c-homeBtnn text-center"
             />{pageTitle}
          </h1>
        </div>
        }
