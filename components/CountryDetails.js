      ...
      <div className="row">
        <div className="col-lg-2 col-md-6 col-sm-12 col-xs-12">
          <div className="countryDetails_cell">
            ...
            {(props.capital) ? <p className="fontSize2">{props.capital}</p> :
              <p className="color_95">Data not available.</p>}
          </div>
        </div>
      ...
      <div className="row">
        <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div className="countryDetails_cell">
            ...
            {(props.region) ? <p className="fontSize2 wordBreak">{props.region}</p> :
              <p className="color_95">Data not available.</p>}
          </div>
        </div>
        <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div className="countryDetails_cell">
            ...
            {(props.subregion) ? <p className="fontSize2 wordBreak">{props.subregion}</p> :
              <p className="color_95">Data not available.</p>}
          </div>
        </div>
        <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
      ...
      <div className="row">
        ...
        <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div className="countryDetails_cell">
            ...
            {(props.population) ? <p className="fontSize2 wordBreak">{props.population}</p> :
              <p className="color_95">Data not available.</p>}
          </div>
        </div>
        <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div className="countryDetails_cell">
            ...
            {(props.area) ?
              <div><p className="fontSize2 wordBreak">{props.area}<span>&nbsp;km<sup>2</sup></span></p></div> :
              <p className="color_95">Data not available.</p>}
          </div>
        </div>
